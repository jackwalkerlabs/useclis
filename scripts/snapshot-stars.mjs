...
const selected = selectRefreshEntries(Object.entries(repositories), process.env.REFRESH_SLUGS, ([slug]) => slug);
for (const [slug, repo] of selected) {
...
console.log(`Recorded daily GitHub star totals for ${selected.length} repositories.`);
