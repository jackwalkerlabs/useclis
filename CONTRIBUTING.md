...
Licensing and the supplied design bundle are being finalized before the first public release; see [release preparation](docs/RELEASING.md) and [third-party materials](THIRD_PARTY.md).
