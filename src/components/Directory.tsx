...
export default function Directory({ tools, siteUrl }: { tools: Tool[]; siteUrl?: string }) {
  ...
  useEffect(() => {
    const restoreFilters = () => {
      ...
      setSort(initialSort && ['stars', 'homebrew', 'name', 'featured', 'recent', 'active'].includes(initialSort) ? initialSort : 'stars');
